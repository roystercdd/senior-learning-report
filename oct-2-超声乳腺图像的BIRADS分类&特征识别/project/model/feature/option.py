...
def get_args():
    ...
    parser.add_argument('--epochs', type=int, default=200, help='Total Training Times')
    ...
    parser.add_argument('--original_csv_path', type=str, default='./datasets/all.csv', help='Original csv file dir')
    ...
    parser.add_argument('--checkpoint', type=str, default='model/feature/checkpoints/2024-10-24_14-03/checkpoint-000078.pth', help='choose a checkpoint to predict')
    parser.add_argument('--predict_image_path', type=str, default='./datasets/images/1_0086.jpg', help='show ground truth')
